...
namespace FontHandler
{
    public class FontBase
    {
        public Font LoadFont(FontType fontType, string filePath)
        {
            ...
            if (type == null) throw new Exception(String.Format("This FontHandler plugin cannot load fonts"));
        ...
        public void SaveFont(Font font, string filePath)
        {
            ...
            if (type == null) throw new Exception(String.Format("This FontHandler plugin cannot save fonts"));
            var obj = Activator.CreateInstance(type);
